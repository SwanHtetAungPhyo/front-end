...
import { CreateGigFormDefaultValues, CreateGigFormSchema } from "@/lib/schemas";
import { cn } from "@/lib/utils";
import { zodResolver } from "@hookform/resolvers/zod";
import { Category, GigTag } from "@prisma/client";
import {
  Award,
  Check,
  ChevronsUpDown,
...
const CreateGigForm = ({ tags, categories }: GigFormProps) => {
  ...
  const form = useForm({
    ...
    defaultValues: CreateGigFormDefaultValues,
  });

  const onSubmit = async (data: z.infer<typeof CreateGigFormSchema>) => {
    toast.promise(async () => createGig(data), {
    ...
    <main>
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2 text-primary">
          Create Your Crypto Gig
        </h1>
        <p className="text-muted-foreground mb-6">
          Complete all steps to publish your gig to the marketplace
        </p>
      </div>
